...
import { tableNhomDanhMucDataType } from "@/interface/nhomDanhMuc/nhomDanhMuc";
...
const NhomDanhMucDetail: React.FC<NhomDanhMucViewProps> = ({ NhomDanhMuc, isOpen, onClose }) => {
    return (
        <Drawer
