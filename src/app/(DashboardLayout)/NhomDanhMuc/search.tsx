...
import { searchNhomDanhMucData } from "@/interface/nhomDanhMuc/nhomDanhMuc";
    ...
    return <>
        <Card className={`${classes.customCardShadow} ${classes.mgButton10}`} >
            ...
            >
                <Row gutter={24}>
                    <Col span={12}>
                        <Form.Item<searchNhomDanhMucData> label="Mã nhóm danh mục" name="groupCode">
                            <Input placeholder="Mã nhóm danh mục" />
                        </Form.Item>
                    </Col>
                    <Col span={12}>
                        <Form.Item<searchNhomDanhMucData> label="Tên nhóm danh mục" name="groupName">
